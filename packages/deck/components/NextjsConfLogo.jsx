...
export function NextjsConfLogoBG() {
  ...
  const propsSphere = {
    width: size,
    height: size,
    coefs: { cx2: 0.707, cy2: 0.707, cxt: 0, cyt: 0, ct: -1 },
    frames: 240,
    pause: false,
    showInfo: true,
    shuttle: false,
  ...
  return (
    <div>
      {/* <h2>Next.js Conf '20</h2> */}
      <AbsoluteCenteredFloat top={320} left={320} filter={'hue-rotate(280deg)'}>
        <View {...propsSphere} t0={0}></View>
      </AbsoluteCenteredFloat>
      <AbsoluteCenteredFloat top={320} left={418} filter={'hue-rotate(0deg)'}>
        <View {...propsSphere} t0={40}></View>
      </AbsoluteCenteredFloat>
      <AbsoluteCenteredFloat top={320} left={516} filter={'hue-rotate(140deg)'}>
...
export function NextjsConfLogo({color='#aaa',alpha=0.6}) {
  return (
    <div
      style={{
