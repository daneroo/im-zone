  ...
  return (
    <>
      ...
      <Flex sx={{ gap: 2, my: 1, alignItems: 'center' }}>
        <Label sx={{ flex: 1 }} htmlFor='size'>Engine</Label>
...
function BorderRect ({ w, stroke = 'none', fill = 'none', epsilon = 0.01, selected = false }) {
  return (
    <rect
...
function JavaScriptLogo ({ selected }) {
  ...
  // eslint-disable-next-line react/jsx-pascal-case
    <SVG viewBox='0 0 630 630'>
      <BorderRect w={w} fill={jsYellow} stroke='black' selected={selected} />
...
function RustLogo ({ selected }) {
  ...
  // eslint-disable-next-line react/jsx-pascal-case
    <SVG viewBox='0 0 144 144'>
      <BorderRect w={w} fill={rust} stroke='black' selected={selected} />
...
function GoLogo ({ selected }) {
  ...
  // eslint-disable-next-line react/jsx-pascal-case
    <SVG viewBox='0 0 255 255'>
      <BorderRect w={w} fill={gopherBlue} stroke='black' selected={selected} />
