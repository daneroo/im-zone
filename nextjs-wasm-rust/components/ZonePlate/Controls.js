...
export function OldRendererSelector ({ renderer, setRenderer }) {
  return (
    <>
...
export function RendererSelector ({ renderer, setRenderer }) {
  const size = 48
  const engineNames = {
    JS: { name: 'JavaScript', icon: <JavaScriptLogo /> },
    Rust: { name: 'Rust', icon: <RustLogo /> },
...
function RustLogo () {
  ...
  // eslint-disable-next-line react/jsx-pascal-case
    <SVG viewBox='0 0 144 144'>
      <rect width='144' height='144' fill={rust} />
...
function GoLogo () {
  ...
  return (
  // eslint-disable-next-line react/jsx-pascal-case
    <SVG viewBox='0 0 254.5 225'>
      <rect width='255' height='225' fill='#00ACD7' />
      <g>
        <g>{/* speed bands */}
          <path
